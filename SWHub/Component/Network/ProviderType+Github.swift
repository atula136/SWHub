...
extension ProviderType {
    ...
    func repository(user: String, project: String) -> Observable<GithubRepository> {
        return self.githubNetworking.requestObject(.repository(fullname: "\(user)/\(project)"), type: GithubRepository.self)
    }
